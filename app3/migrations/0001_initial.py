    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(to='app3.Currency', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(to='app3.Currency', on_delete=models.CASCADE)),
                ('wallet', models.ForeignKey(to='app3.Wallet', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='wallet',
            field=models.ForeignKey(to='app3.Wallet', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='address',
            name='currency',
            field=models.ForeignKey(to='app3.Currency', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='address',
            name='wallet',
            field=models.ForeignKey(related_name='addresses', blank=True, to='app3.Wallet', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
